---
title: "[AIO25-16WR] Ngày 2"
date: 2025 Feb 04
categories: [AI Vietnam, Python, Mathematics]
tags: [for-loop, euler-constant, prime-numbers, eratosthenes-sieve, number-theory]
math: true
...
$$ \text{A} = \text{P} \left(1 + \frac{r}{n}\right)^{n.t} $$
...
$$ \text{A} = \text{P} \left(1 + \frac{r}{n}\right)^{n.t} = 1 \cdot \left(1 + \frac{1}{n}\right)^{n \cdot 1} = \left(1 + \frac{1}{n}\right)^{n} $$
