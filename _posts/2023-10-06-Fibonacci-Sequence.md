...
![Fibonacci Sequence light](/assets/img/231006-fibonacci-sequence/fibonacci-sequence-light.png){: .light }
![Fibonacci Sequence dark](/assets/img/231006-fibonacci-sequence/fibonacci-sequence-dark.png){: .dark }
...
![Fibonacci Linear Calculate light](/assets/img/231006-fibonacci-sequence/fibonacci-linear-calculate-light.gif){: .light }
![Fibonacci Linear Calculate dark](/assets/img/231006-fibonacci-sequence/fibonacci-linear-calculate-dark.gif){: .dark }
...
![Fibonacci Recursive Method light](/assets/img/231006-fibonacci-sequence/fibonacci-recursive-method-light.gif){: .light }
![Fibonacci Recursive Method dark](/assets/img/231006-fibonacci-sequence/fibonacci-recursive-method-dark.gif){: .dark }

#### Cải tiến

Để cải thiện thuật toán, ta sẽ lưu trữ các giá trị đã tính toán, để tránh phải lặp lại nhiều lần.

![Fibonacci Recursive with Cache Method light](/assets/img/231006-fibonacci-sequence/fibonacci-recursive-cache-method-light.gif){: .light }
![Fibonacci Recursive with Cache Method dark](/assets/img/231006-fibonacci-sequence/fibonacci-recursive-cache-method-dark.gif){: .dark }
...
![Matrix Multiply light](/assets/img/231006-fibonacci-sequence/matrix-multiplier-light.png){: .light }
![Matrix Multiply dark](/assets/img/231006-fibonacci-sequence/matrix-multiplier-dark.png){: .dark }
