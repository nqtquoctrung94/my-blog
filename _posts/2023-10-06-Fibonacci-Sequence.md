...
![Fibonacci Sequence light](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-sequence-light.png){: .light }
![Fibonacci Sequence dark](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-sequence-dark.png){: .dark }
...
![Fibonacci Linear Calculate light](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-linear-calculate-light.gif){: .light }
![Fibonacci Linear Calculate dark](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-linear-calculate-dark.gif){: .dark }

#### Thuật toán

Dưới đây là thuật toán Python sử dụng vòng lặp
...
![Fibonacci Recursive Method light](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-recursive-method-light.gif){: .light }
![Fibonacci Recursive Method dark](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-recursive-method-dark.gif){: .dark }

#### Cải tiến

Để cải thiện thuật toán, ta sẽ lưu trữ các giá trị đã tính toán, để tránh phải lặp lại nhiều lần.

![Fibonacci Recursive with Cache Method light](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-recursive-cache-method-light.gif){: .light }
![Fibonacci Recursive with Cache Method dark](/my-blog/assets/img/20231006-fibonacci-sequence/fibonacci-recursive-cache-method-dark.gif){: .dark }
...
![Matrix Multiply light](/my-blog/assets/img/20231006-fibonacci-sequence/matrix-multiplier-light.png){: .light }
