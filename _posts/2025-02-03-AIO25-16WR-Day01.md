---
title: "[AIO25-16WR] Ngày 1"
date: 2025 Feb 03
categories: [AI Vietnam, Python, Machine Learning] 
tags: [if-else, activation-functions, relu, sigmoid, tanh, logic-control]
math: true
...
![if else condition flow light](/my-blog/assets/img/20250203-AIO25-16WR-Day01/if-elif-elif-else-light.png){: .light }
![if else condition flow dark](/my-blog/assets/img/20250203-AIO25-16WR-Day01/if-elif-elif-else-dark.png){: .dark }
