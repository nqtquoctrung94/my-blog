...
{% highlight python %}
if điều_kiện:
    # Lệnh sẽ chạy khi điều kiện đúng
elif điều_kiện_khác_1:
    # Lệnh sẽ chạy khi điều_kiện sai và điều_kiện_khác_1 đúng
elif điều_kiện_khác_2:
    # Lệnh sẽ chạy khi cả 2 điều kiện trên đều sai và điều_kiện_khác_2 đúng
else:
